  ...
  return (
    <>
      <Section className="bg-[#17365d] text-white pt-16 pb-24 text-center" bgWhite={false}>
        <h1 className="text-4xl font-extrabold sm:text-5xl mb-6">Battery & Inverter Systems</h1>
        <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-200">
          High-quality, reliable, and sustainable battery & inverter systems for your needs.
        </p>
      </Section>
      <Section>
