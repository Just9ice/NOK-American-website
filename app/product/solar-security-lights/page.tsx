    ...
    <>
      <Section className="bg-[#17365d] text-white pt-16 pb-24 text-center" bgWhite={false}>
        <ScrollReveal animation="fade-up">
          <h1 className="text-4xl font-extrabold sm:text-5xl mb-6">Solar & Security Lights</h1>
        </ScrollReveal>
        <ScrollReveal animation="fade-up" delay={0.2}>
          <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-200">
            High-quality, reliable, and sustainable solar & security lights for your needs.
          </p>
        </ScrollReveal>
      </Section>
      <Section>
